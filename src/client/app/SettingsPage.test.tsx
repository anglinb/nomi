...
const SAMPLE_RELEASES = [
  {
    ...
    name: "v0.8.1",
    tag_name: "v0.8.1",
    html_url: "https://github.com/jakemor/nomi/releases/tag/v0.8.1",
  ...
  },
  {
    ...
    html_url: "https://github.com/jakemor/nomi/releases/tag/v0.9.0-beta.1",
...
describe("fetchGithubReleases", () => {
  test("filters draft releases and sends the GitHub accept header", async () => {
    ...
    expect(requestedUrl).toBe("https://api.github.com/repos/jakemor/nomi/releases")
...
describe("getKeybindingsSubtitle", () => {
  test("renders the active keybindings path", () => {
    expect(getKeybindingsSubtitle("~/.nomi-dev/keybindings.json")).toBe(
      "Edit global app shortcuts stored in ~/.nomi-dev/keybindings.json."
    )
  })
})
...
describe("ChangelogSection", () => {
  test("renders release cards, markdown, links, and prerelease badges", () => {
    ...
    expect(html).toContain("https://github.com/jakemor/nomi/releases/tag/v0.8.1")
